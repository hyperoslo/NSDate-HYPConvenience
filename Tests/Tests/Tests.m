...
- (void)testDateForDayMonthYear
{
    ...
    XCTAssertEqualObjects(@"2009-12-31 21:00:00 +0000", [self localDateDescription:date]);
}

- (void)testTimeForHourMinute
{
    NSDate *date = [NSDate hyp_timeForHour:10 minute:10];
    XCTAssertEqualObjects(@"2000-01-01 07:10:00 +0000", [self localDateDescription:date]);
}
